...
//-- Cada vez que hay un cambio en la entrada de texto
//-- se ejecuta esta funcion de retrollamada
busqueda.oninput = ()=>{

  console.log("uuuueeeeeee");
  console.log("Texto: " + busqueda.value);

  //-- Elimina los espacios en blanco
  valor_busqueda = busqueda.value.trim()

  //-- Si es la cadena nula no se hace búsqueda
  if (valor_busqueda == "")
    return;
